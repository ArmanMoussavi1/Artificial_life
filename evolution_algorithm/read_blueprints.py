...
#################################################
##   Read in previous simulation information   ##
#################################################

life_blueprint = []
with open('blueprints_to_life.txt', 'r') as file:
    sublist = []
    for line in file:
        line = line.strip()
        if line:
...
#######          #######
#######          #######
####### Settings #######     Make sure to readjust the simulation settings! Find the saved settings at the bottom of blueprints_to_life.txt
#######          #######
#######          #######
########################
global_seed = 123
